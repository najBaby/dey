...
type MovieServiceClient interface {
	...
	Movie(ctx context.Context, in *MovieRequest, opts ...grpc.CallOption) (*MovieResponse, error)
}
...
func (c *movieServiceClient) ListMovies(ctx context.Context, in *ListMoviesRequest, opts ...grpc.CallOption) (*ListMoviesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.api.MovieService/ListMovies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) Movie(ctx context.Context, in *MovieRequest, opts ...grpc.CallOption) (*MovieResponse, error) {
	out := new(MovieResponse)
	err := c.cc.Invoke(ctx, "/google.api.MovieService/Movie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MovieServiceServer interface {
	...
	Movie(context.Context, *MovieRequest) (*MovieResponse, error)
...
func (UnimplementedMovieServiceServer) Movie(context.Context, *MovieRequest) (*MovieResponse, error) {
...
func _MovieService_ListMovies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.api.MovieService/ListMovies",
	}
...
func _MovieService_Movie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.api.MovieService/Movie",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MovieService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.api.MovieService",
